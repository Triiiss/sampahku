    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Cetak PDF Data Pembelian</h4>
        </div>
        <div class="modal-body">
          <form action="./report/cetak_pembelian.php" method="post" target="_blank">
            <table>
              <tr>
                <td>
        ...
        <div class="modal-footer">
          <a href="./report/cetak_pembelian.php" target="_blank" class="btn btn-primary btn-sm">Cetak Semua Data</a>
        </div>
      </div>
    </div>
  </div>
